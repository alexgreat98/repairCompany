...
@section('content')
    <div class="index__page-wrap">
        <div class="index__page-banner swiper-container index_banner">
            <!-- Additional required wrapper -->
            <div class="swiper-wrapper">
                <!-- Slides -->
                <div class="swiper-slide index__page-banner-slider">
                    <img src="{{Storage::url('/site/remont-ofisov-.jpg')}}" class="img-fluid" alt="services">
                    <span class="index__page-banner-title">Ремонт офисов</span>
                    <span class="index__page-banner-text">Ремонт, выполненный мастерами компании отвечает всем современным стандартам.</span>
                </div>
                <div class="swiper-slide index__page-banner-slider">
                    <img src="{{Storage::url('/site/remont-ofisov-.jpg')}}" class="img-fluid" alt="services">
                    <span class="index__page-banner-title">Ремонт офисов</span>

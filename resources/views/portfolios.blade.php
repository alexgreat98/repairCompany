@extends('layouts.app')
@section('head')
    <title>Порфолио ООО «Строй-Комплект» | Наши работы</title>
    <meta name="description"
          content="Компания ООО «Строй-Комплект» выполнила не мало проектов. Мы гордимся нашими довольными клиентами">
